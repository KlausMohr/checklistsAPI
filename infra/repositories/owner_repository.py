...
from entities.owner_entity import Owner
from infra.database_config.database_config import DBConnection
from infra.response_generator.response_gen import response_gen
