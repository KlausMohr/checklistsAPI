...
class RoadTest(db.Model):
    ...
    auto_manual_transmission_shifting = db.Column(db.SmallInteger(), nullable=False)
    auto_manual_transmission_noise = db.Column(db.SmallInteger(), nullable=False)
    shift_interlock_operation = db.Column(db.SmallInteger(), nullable=False)
    drive_axle_transer_case_operation = db.Column(db.SmallInteger(), nullable=False)
